...
function NavComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("href", ctx_r1.cta.href, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.cta.label, " ");
  }
}
function NavComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", ctx_r1.cta.routerLink || "/About");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.cta.label, " ");
  }
}
var NavComponent = class _NavComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavComponent, selectors: [["fv-nav"]], inputs: { dark: "dark", cta: "cta" }, decls: 12, vars: 4, consts: [[3, "ngClass"], [1, "nav-in"], ["routerLink", "/", 1, "brand"], ["src", "assets/images/logo_1.png", "alt", "Foovante Logo", 1, "w-16", "h-16"], [1, "nav-links"], ["routerLinkActive", "active", 3, "routerLink", "routerLinkActiveOptions"], [1, "nav-cta"], ["routerLink", "/", 1, "btn", "btn-ghost", "btn-sm"], ["target", "_blank", "rel", "noopener", 1, "btn", "btn-primary", "btn-sm", 3, "href"], [1, "btn", "btn-primary", "btn-sm", 3, "routerLink"]], template: function NavComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(9, "Sign in");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(10, NavComponent_Conditional_10_Template, 2, 2, "a", 8)(11, NavComponent_Conditional_11_Template, 2, 2, "a", 9);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(2, _c0, ctx.dark));
        \u0275\u0275advance(5);
        \u0275\u0275repeater(ctx.navLinks);
        \u0275\u0275advance(5);
        \u0275\u0275conditional(ctx.cta.href ? 10 : 11);
      }
...
(() => {
  ...
  <div class="nav-in">
    <a routerLink="/" class="brand">
      <img src="assets/images/logo_1.png" alt="Foovante Logo" class="w-16 h-16" />
    ...
    <div class="nav-cta">
      ...
      @if (cta.href) {
        <a [href]="cta.href" target="_blank" rel="noopener" class="btn btn-primary btn-sm">
          {{ cta.label }}
        </a>
      } @else {
...
var FooterComponent = class _FooterComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["fv-footer"]], decls: 75, vars: 1, consts: [[1, "wrap"], [1, "ft-grid"], ["routerLink", "/", 1, "brand", 2, "margin-bottom", "20px", "display", "inline-flex"], ["src", "assets/images/logo_1.png", "alt", "Foovante Logo", 1, ""], [2, "font-size", "14px", "color", "var(--ink-2)", "line-height", "1.6", "max-width", "28ch", "margin", "0"], [2, "font-size", "12px", "color", "var(--muted)", "margin-top", "20px"], ["routerLink", "/funders"], ["routerLink", "/projects"], ["routerLink", "/investors"], ["routerLink", "/how-mrv-works"], [1, "ft-soon"], ["routerLink", "/"], ["routerLink", "/", "fragment", "team"], ["href", "mailto:press@foovante.com"], ["routerLink", "/founder-brief"], ["routerLink", "/privacy-policy"], ["routerLink", "/terms-of-service"], [1, "ft-bottom"], [1, "partners"]], template: function FooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(30, "li")(31, "span", 10);
        \u0275\u0275text(32, "Blog \xB7 coming soon");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(33, "div")(34, "h5");
        \u0275\u0275text(35, "Company");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(36, "ul")(37, "li")(38, "a", 11);
        \u0275\u0275text(39, "About");
        \u0275\u0275elementEnd()();
...
//# sourceMappingURL=chunk-EOORU742.js.map
