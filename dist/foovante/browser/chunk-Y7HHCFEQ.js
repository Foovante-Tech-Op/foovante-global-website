  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProjectsComponent, selectors: [["fv-projects"]], decls: 262, vars: 10, consts: [[3, "dark", "cta"], ["eyebrow", "For project developers", "lead", "Foovante helps African renewable-energy, agriculture, and forestry projects generate, verify, and sell carbon credits, without London middlemen taking 40%. Built in Accra, for projects on the continent.", 3, "slides", "lines", "cta1", "cta2"], [1, "stats"], [1, "wrap"], [1, "stats-grid"], [1, "stat"], [1, "n"], [1, "l"], [1, "sec-head"], [1, "eyebrow"], [2, "margin-top", "24px"], [1, "right"], [1, "steps"], [1, "step"], ["id", "verify", 1, "verify-band"], [1, "verify-grid"], [1, "verify-card"], [1, "num"], ["id", "methodology", 1, "methods"], [1, "method-grid"], [1, "method"], ["id", "network"], [1, "priority-sec"], [1, "pri-grid"], [1, "pri"], ["id", "apply", 1, "apply"], [1, "apply-grid"], [1, "story"], [2, "margin-top", "24px", "font-size", "28px"], [1, "attrib"], [1, "av"], [1, "nm"], [1, "ro"], [2, "display", "flex", "gap", "32px", "margin-top", "48px", "flex-wrap", "wrap"], [2, "font-family", "var(--font-display)", "font-size", "36px", "font-weight", "700", "letter-spacing", "-0.03em", "line-height", "1"], [2, "font-size", "13px", "color", "var(--muted)", "margin-top", "8px", "font-weight", "500"], [1, "apply-form"], [1, "sub"], [1, "stepper"], [1, "dot", "active"], [1, "seg", "active"], [1, "dot"], [1, "seg"], [1, "field"], ["type", "text", "placeholder", "e.g. Volta Estuary Mangroves"], [1, "field-row"], ["value", "gh"], ["value", "ng"], ["value", "ke"], ["value", "rw"], ["value", "et"], ["value", "tz"], ["value", "ug"], ["value", "sn"], ["value", "ci"], ["value", "cm"], ["value", "za"], ["value", "mz"], ["value", "mw"], ["value", "zm"], ["type", "number", "placeholder", "e.g. 2500"], ["type", "text", "placeholder", "e.g. Kwame Asante \xB7 Project Manager"], ["type", "email", "placeholder", "you@project.org"], [1, "btn", "btn-primary", 2, "width", "100%", "justify-content", "center"], [1, "arrow"], [2, "font-size", "12px", "color", "var(--muted)", "text-align", "center", "margin", "0"], [1, "cta"], [1, "cta-in"], [1, "cta-actions"], ["routerLink", "/founder-brief", 1, "btn", "btn-primary", "btn-lg"], ["routerLink", "/founder-brief", 1, "btn", "btn-ghost", "btn-lg"], [1, "step-n"], [1, "meta"], [1, "badge"], [1, "desc"], [1, "footer"]], template: function ProjectsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(86, "6 core methodologies. Pick the one that fits your land.");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(87, "div", 11)(88, "p");
        \u0275\u0275text(89, "Foovante is building toward full Verra, Gold Standard, and Plan Vivo catalog coverage. These six methodologies cover the vast majority of qualifying African land types and are supported on the platform today.");
        \u0275\u0275elementEnd()()();
        ...
        \u0275\u0275text(100, "Be among the first projects on the platform.");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(101, "div", 11)(102, "p");
        \u0275\u0275text(103, "We are starting in Ghana and building outward. Every project on Foovante is monitored from our Accra-based operations centre.");
        \u0275\u0275elementEnd()()();
        ...
        \u0275\u0275text(253, "Be among the first projects verified on Foovante. Apply in 10 minutes; we'll be back within 24 hours.");
        \u0275\u0275elementEnd();
  ...
  <div class="wrap">
    <div class="sec-head">
      <div>
        ...
        <h2 style="margin-top:24px">Four steps from land to listed.</h2>
      </div>
      <div class="right">
        <p>Most platforms take 18\u201324 months to get a project to first issuance. Foovante's unified MRV and standards pipeline averages twelve weeks, because we've already done the standards work for you.</p>
      </div>
    </div>
    <div class="steps">
  ...
  <div class="wrap">
    <div class="sec-head">
      <div>
        ...
        <h2 style="margin-top:24px">Every tonne, watched from orbit and the ground.</h2>
      </div>
      <div class="right">
        <p>You shouldn't have to take our word for any credit. Foovante runs a four-layer verification stack: satellite, field, third-party, on-chain. Every funder gets the full audit trail, per tonne.</p>
      </div>
    </div>
    <div class="verify-grid">
      <div class="verify-card">
        <div class="num">01</div>
        <h4>Satellite baseline</h4>
        <p>7+ years of Sentinel-2 imagery for every project polygon. Monitored every 5 days at 10m resolution, automatically.</p>
      </div>
      <div class="verify-card">
        <div class="num">02</div>
        <h4>Field truth</h4>
        <p>Local agents capture soil samples, biomass plots, and household surveys via the Foovante mobile app. Lab results upload directly to the audit trail.</p>
      </div>
      <div class="verify-card">
        <div class="num">03</div>
        <h4>Independent verifier</h4>
        <p>Verra, Gold Standard, and Plan Vivo verifiers receive a unified dossier. Average review cycle: six weeks, not six months.</p>
      </div>
      <div class="verify-card">
        <div class="num">04</div>
        <h4>On-chain serialisation</h4>
        <p>Every issued credit hashed and serialised. You see the exact tonne, polygon, and vintage; so does anyone you share it with.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div class="sec-head">
      <div>
        ...
        <h2 style="margin-top:24px">Be among the first projects on the platform.</h2>
      </div>
      <div class="right">
        <p>We are starting in Ghana and building outward. Every project on Foovante is monitored from our Accra-based operations centre.</p>
      </div>
    </div>
...
<section class="cta">
  <div class="cta-in">
    ...
    <div class="cta-actions">
      <a class="btn btn-primary btn-lg" routerLink="/founder-brief">Apply to list <span class="arrow">\u2192</span></a>
...
//# sourceMappingURL=chunk-Y7HHCFEQ.js.map
