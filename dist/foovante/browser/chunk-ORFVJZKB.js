...
var GrowthChartComponent = class _GrowthChartComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GrowthChartComponent, selectors: [["fv-growth-chart"]], decls: 3, vars: 0, consts: [[1, "growth-bars"], [1, "g-bar"], [1, "g-val"], [1, "g-fill"], [1, "g-lbl"]], template: function GrowthChartComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(GrowthChartComponent, [{
    type: Component,
    args: [{ selector: "fv-growth-chart", standalone: true, template: '<div class="growth-bars">\n  @for (bar of bars; track bar.month) {\n    <div class="g-bar">\n      <div class="g-val">${{ bar.value }}k</div>\n      <div class="g-fill" [style.height]="bar.height"></div>\n      <div class="g-lbl">{{ bar.month }}</div>\n    </div>\n  }\n</div>\n', styles: ["/* src/app/shared/components/growth-chart/growth-chart.component.scss */\n:host {\n  display: block;\n}\n.growth-bars {\n  display: flex;\n  align-items: flex-end;\n  gap: 6px;\n  height: 200px;\n  padding-top: 32px;\n  width: 100%;\n}\n.g-bar {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 6px;\n  position: relative;\n}\n.g-val {\n  font-size: 9px;\n  color: var(--muted);\n  font-weight: 500;\n  white-space: nowrap;\n}\n.g-fill {\n  width: 100%;\n  background:\n    linear-gradient(\n      180deg,\n      var(--green) 0%,\n      var(--green-deep) 100%);\n  border-radius: 3px 3px 0 0;\n  transition: height 0.8s ease;\n  min-height: 4px;\n}\n.g-lbl {\n  font-size: 10px;\n  color: var(--muted);\n  font-weight: 500;\n}\n/*# sourceMappingURL=growth-chart.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
var InvestorsComponent = class _InvestorsComponent {
  constructor() {
    this.heroSlides = [
      ...
      },
      {
        ...
        sub: "3 projects \xB7 baseline phase \xB7 Ghana",
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InvestorsComponent, selectors: [["fv-investors"]], decls: 163, vars: 10, consts: [[3, "dark", "cta"], ["eyebrow", "For investors", "lead", "We're raising the company building the rails for Africa's carbon markets. $12M Series A, open to thesis-aligned funds through Q3 2026.", 3, "slides", "lines", "cta1", "cta2"], [1, "stats"], [1, "wrap"], [1, "stats-grid"], [1, "stat"], [1, "n"], [1, "l"], ["id", "traction", 1, "traction"], [1, "sec-head"], [1, "eyebrow"], [2, "margin-top", "24px"], [1, "right"], [1, "traction-grid"], [1, "panel"], [1, "sub"], [1, "big-n"], [2, "margin-top", "auto"], [1, "delta"], [2, "margin-top", "auto", "font-size", "14px", "color", "var(--ink-2)"], [1, "panel", "large"], [2, "display", "flex", "justify-content", "space-between", "align-items", "flex-start"], [1, "growth-chart"], ["id", "moat", 1, "moat", 2, "background", "var(--paper)"], [1, "moat-grid"], [1, "moat-card"], ["id", "model"], [1, "model-grid"], [1, "model-visual"], [1, "credit-stack"], [1, "cs-row"], [2, "background", "var(--green)"], [2, "background", "var(--gold)"], [2, "background", "var(--ink-2)"], [2, "background", "var(--muted)"], [1, "credit-label"], [2, "font-family", "var(--font-display)", "font-size", "28px", "font-weight", "600", "letter-spacing", "-0.025em", "margin", "0 0 24px"], [1, "fee-list"], [1, "cta"], [1, "cta-in"], [1, "cta-actions"], ["routerLink", "/founder-brief", 1, "btn", "btn-primary", "btn-lg"], [1, "arrow"], ["routerLink", "/founder-brief", 1, "btn", "btn-ghost", "btn-lg"], [1, "num"], [1, "fee-pct"]], template: function InvestorsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(55, "Active projects \xB7 baseline phase");
        \u0275\u0275elementEnd()();
...
<div class="stats">
  <div class="wrap">
    <div class="stats-grid">
      <div class="stat"><div class="n">$1.4M</div><div class="l">ARR run-rate \xB7 Q2 2026</div></div>
      <div class="stat"><div class="n">38%</div><div class="l">MoM growth \xB7 9 straight months</div></div>
      <div class="stat"><div class="n">282</div><div class="l">Active projects</div></div>
      <div class="stat"><div class="n">96%</div><div class="l">Revenue retention</div></div>
    </div>
  </div>
</div>
  ...
  <div class="wrap">
    <div class="sec-head">
      <div>
        ...
        <h2 style="margin-top:24px">Real GMV. Real growth. Real signals.</h2>
      </div>
      <div class="right">
        <p>$1.4M ARR run-rate as of Q2 2026, growing 38% month-over-month for nine straight months. Below: live dashboard you'll see in the data room.</p>
      </div>
    </div>
    ...
    <div class="traction-grid">
      <div class="panel">
        <div>
          <h3>Annualised revenue</h3>
          <p class="sub">Run-rate \xB7 Q2 2026</p>
        </div>
        <div class="big-n">$1.4<small>M ARR</small></div>
        <div style="margin-top:auto"><span class="delta">\u2191 38% MoM avg.</span></div>
      </div>

      <div class="panel">
        <div>
          <h3>Active projects</h3>
          <p class="sub">Active projects \xB7 baseline phase</p>
        </div>
        <div class="big-n">282</div>
        <div style="margin-top:auto;font-size:14px;color:var(--ink-2)">
          From <strong>14 at YE2023</strong> \xB7 20\xD7 in 18 months
        </div>
      </div>
      ...
      <div class="panel">
        <div>
          <h3>Renewal rate</h3>
          <p class="sub">Project developers \xB7 trailing 12M</p>
        </div>
        <div class="big-n">96<small>%</small></div>
        <div style="margin-top:auto;font-size:14px;color:var(--ink-2)">
          Net-revenue retention <strong>132%</strong> across funder cohort.
        </div>
      </div>
      ...
      <div class="panel large">
        <div style="display:flex;justify-content:space-between;align-items:flex-start">
          <div>
            <h3>Monthly GMV ($k) \xB7 trailing 12 months</h3>
            <p class="sub">Total platform credit volume settled \xB7 Jul 2025 \u2192 Jun 2026</p>
          </div>
          <span class="delta">+38% MoM</span>
        </div>
        <div class="growth-chart">
          <fv-growth-chart></fv-growth-chart>
        </div>
      </div>
    </div>
  </div>
...
<section class="moat" id="moat" style="background:var(--paper)">
  <div class="wrap">
    <div class="sec-head">
      ...
      <div class="right">
        <p>Anyone can build a marketplace. The defensible asset is the MRV stack; it's a 7-year, multi-million-dollar effort to replicate. We're three years in.</p>
      </div>
    </div>
    <div class="moat-grid">
...
<section class="cta">
  <div class="cta-in">
    ...
    <div class="cta-actions">
      ...
      <a class="btn btn-ghost btn-lg" routerLink="/founder-brief">Talk to the founders</a>
    </div>
  </div>
</section>
...
//# sourceMappingURL=chunk-ORFVJZKB.js.map
