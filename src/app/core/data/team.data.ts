import { TeamMember, Advisor, Method } from '../models/team.model';
...
export const LEADERSHIP: TeamMember[] = [
  {
    ...
    prior: 'Previously: Standard Bank · McKinsey Sustainability · MPP Harvard Kennedy',
  ...
  },
  {
    ...
    prior: 'Previously: Planet Labs · NASA SERVIR · MS Stanford',
  ...
  },
  {
    ...
    prior: 'Previously: One Acre Fund · TechnoServe · MBA Strathmore',
    pic: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=900&q=80&auto=format&fit=crop'
  },
  {
    name: 'Théo Diallo',
    role: 'Head of Verification',
    bio: "Théo was a lead verifier at Verra and senior auditor at SCS Global Services for nine years. He has personally validated more than 200 African carbon projects and now leads Foovante's verification operations across all three standards.",
    prior: 'Previously: Verra · SCS Global Services',
    pic: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=900&q=80&auto=format&fit=crop'
  }
];

export const OPS_TEAM: TeamMember[] = [
  {
    name: 'Kwame Asante',
